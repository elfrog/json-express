...
var ListBuilder = {
    ...
    build: function (data) { return __awaiter(_this, void 0, void 0, function () {
...
var DataBinder = {
    ...
    transform: function (data, ctx) { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            ctx[data.binding || '$'] = data.data;
            return [2 /*return*/, data.rest];
        });
    }); }
};
...
describe('JsonExpress', function () {
    ...
    it('matches schema types', function () { return __awaiter(_this, void 0, void 0, function () {
        var je, result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    je = new json_express_1.default([SchemaMatchBuilder]);
                    return [4 /*yield*/, je.build({
                            type: 'SchemaMatch',
                            data: '{=name}',
                            notable: false
    ...
    it('does not accept invalid column types', function () {
        assert_1.throws(function () {
            new json_express_1.default([
                {
                    schema: { type: 'newtype' }
    ...
    it('uses placeholder before complete build', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    je = new json_express_1.default([PlaceholderTransformer, ListBuilder]);
                    midResults = [];
                    return [4 /*yield*/, je.build({
                            items: [
