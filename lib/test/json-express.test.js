...
var DataBinder = {
    ...
    build: function (data, ctx) {
        var _a;
        return data.rest(__assign({}, ctx, (_a = {}, _a[data.bidning || '$'] = data.data, _a)));
    }
};
...
describe('JsonExpress', function () {
    ...
    it('matches types', function () {
        var je = new json_express_1.default([BodyBuilder, ListBuilder]);
        assert_1.rejects(function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
        ...
        assert_1.doesNotReject(function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, je.build({
                            body: {
