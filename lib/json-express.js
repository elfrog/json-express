    ...
    JsonExpress.prototype.buildExpression = function (expression, context, cb) {
        ...
        if (Array.isArray(expression)) {
            ...
            var _loop_1 = function (i) {
                this_1.buildExpression(expression[i], context, function (v) {
                    arr_1[i] = v;
                    checker_1[i] = true;
                    if (completed_1 || checker_1.every(function (ch) { return ch; })) {
                        completed_1 = true;
                        cb(arr_1);
                    }
                });
            ...
            if (handleKeys_2.length > 0) {
                ...
                var _loop_2 = function (key) {
                    this_2.buildExpression(expression[key], context, function (v) {
                        target_1[key] = v;
                        checker_2.add(key);
