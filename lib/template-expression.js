...
var TemplateExpression = /** @class */ (function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 5:
                        ...
                        r = pipeHandler.apply(void 0, __spreadArrays([v], args));
                        _c = (_b = stack).push;
    ...
    TemplateExpression.cache = function (source, context) {
        if (context === void 0) { context = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var hash, t;
            return __generator(this, function (_a) {
                hash = md5_1.default(source);
                t = null;
    ...
    TemplateExpression.templateCache = new Map();
